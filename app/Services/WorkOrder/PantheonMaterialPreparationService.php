...
class PantheonMaterialPreparationService
{
    ...
    public function prepare(ConnectionInterface $db, array $workOrder, array $items, Carbon $now, int $userId, string $maker = ''): array
    {
