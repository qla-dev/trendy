...
<div class="misc-wrapper">
  <a class="brand-logo" href="#">
    ...
    <h2 class="brand-text text-primary ms-1">eNalog.app</h2>
  </a>
  <div class="misc-inner p-2 p-sm-3">
    <div class="w-100 text-center">
      ...
      <img class="img-fluid" src="{{ asset('images/pages/coming-soon-dark.svg') }}" alt="Soon page" />
      @else
      <img class="img-fluid" src="{{ asset('images/pages/coming-soon.svg') }}" alt="Soon page" />
      @endif
    </div>
  </div>
</div>
