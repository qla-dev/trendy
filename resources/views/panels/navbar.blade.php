@if ($configData['mainLayoutType'] === 'horizontal' && isset($configData['mainLayoutType']))
  ...
  @else
    <nav
      class="header-navbar navbar navbar-expand-lg align-items-center {{ $configData['navbarClass'] }} navbar-light navbar-shadow {{ $configData['navbarColor'] }} {{ $configData['layoutWidth'] === 'boxed' && $configData['verticalMenuNavbarType'] === 'navbar-floating'? '': '' }}">
@endif
  ...
  <ul class="nav navbar-nav align-items-center ms-auto">
    ...
    <li class="nav-item dropdown dropdown-user">
      <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
        ...
        @php
          $navbarAvatarImage = strtolower((string) optional(Auth::user())->username) === 'admin'
            ? 'avatar-s-22.jpg'
            : 'avatar-s-11.jpg';
        @endphp
        <span class="avatar">
          <img class="round"
            src="{{ asset('images/portrait/small/' . $navbarAvatarImage) }}"
