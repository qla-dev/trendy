      ...
      <li class="nav-item me-auto">
        <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
          <span class="brand-logo">
            <img src="{{ asset('/images/logo/TrendyCNC.png') }}" alt="eNalog.app" height="auto" width="36">
          </span>
        ...
        @foreach ($menuData[0]->menu as $menu)
          ...
          @else
            ...
            @php
              ...
              $isFontAwesomeIcon = \Illuminate\Support\Str::startsWith($menuIcon, ['fa ', 'fa-', 'fas ', 'far ', 'fal ', 'fab ']);
              $menuIconClass = \Illuminate\Support\Str::startsWith($menuIcon, 'fa-') ? 'fas ' . $menuIcon : $menuIcon;
            @endphp
            <li
