...
Route::middleware('auth:web')->group(function () {
    // Main Page Route
    Route::get('/', [DashboardController::class, 'home'])->name('dashboard-ecommerce');
    ...
    Route::group(['prefix' => 'app'], function () {
        ...
        Route::get('orders-test', [OrderController::class, 'ordersLinkageIndex'])->name('app-orders-test');
        Route::get('orders-test/data', [OrderController::class, 'ordersLinkageData'])->name('app-orders-test-data');
        Route::get('orders-test/positions', [OrderController::class, 'ordersLinkagePositions'])->name('app-orders-test-positions');
        Route::get('orders-test/work-orders', [OrderController::class, 'ordersLinkageWorkOrders'])->name('app-orders-test-work-orders');
        Route::get('radni-nalozi', [OrderController::class, 'ordersLinkageWorkOrdersApi'])->name('app-orders-test-radni-nalozi');
        Route::delete('orders-test', [OrderController::class, 'destroyLinkedOrder'])->name('app-orders-test-destroy');
...
Route::group(['prefix' => 'auth'], function () {
    ...
    Route::post('logout', [AuthenticationController::class, 'logout'])->middleware('auth:web')->name('auth.logout');
});
/* Route Authentication Pages */
